...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    assert_equal "a", "abbcccddddeeeee"[/az*/] # zero z or more
    assert_equal "", "abbcccddddeeeee"[/z*/] # returns empty string for * !!!
  ...
  def test_the_left_most_match_wins
    assert_equal "a", "abbccc az"[/az*/] # zero z or more and a is the first
  end
  ...
  def test_a_character_class_can_be_negated
    assert_equal "the number is ", "the number is 42"[/[^0-9]+/] # not match the digits
  end

  def test_shortcut_character_classes_are_negated_with_capitals # capital letter means not match!
  ...
  def test_caret_anchors_to_the_start_of_lines # different with negate!!
